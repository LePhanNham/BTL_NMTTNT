...
import bfs
import astar
from Sources.support_function import find_position_player, determine_move_direction
...
def sokoban():
	...
	while running:
		...
		if sceneState == "playing":
			clock.tick(4)
			if currentState > 0:
				prev_player_pos = find_position_player(list_board[0][currentState - 1])
				current_player_pos = find_position_player(list_board[0][currentState])
				move_direction = determine_move_direction(prev_player_pos, current_player_pos)
...
def initGame(map):
	...
	desText = desSize.render('Chon level!!!', True, WHITE)
...
def loadingGame():
	...
	text_2 = fontLoading_2.render('Dang tim duong di!', True, WHITE)
...
def foundGame(map):
	...
	text_1 = font_1.render('win', True, WHITE)
	text_rect_1 = text_1.get_rect(center=(320, 100))
	screen.blit(text_1, text_rect_1)

	font_2 = pygame.font.Font('gameFont.ttf', 20)
	text_2 = font_2.render('Nhan enter de tiep tuc', True, WHITE)
...
def notfoundGame():
	...
	text_1 = font_1.render('Khong giai duoc', True, WHITE)
	text_rect_1 = text_1.get_rect(center=(320, 100))
	screen.blit(text_1, text_rect_1)

	font_2 = pygame.font.Font('gameFont.ttf', 20)
	text_2 = font_2.render('Nhan enter đe tiep tuc', True, WHITE)
	text_rect_2 = text_2.get_rect(center=(320, 600))
	screen.blit(text_2, text_rect_2)
